...
data = open('/OneDrive/ドキュメント/GitHub/lesson01/5-3/playdata.json', 'r' ,encoding="utf-8_sig")
data_dict = json.load(data)['data']

songs = open('/OneDrive/ドキュメント/GitHub/lesson01/5-3/songs.json', 'r' ,encoding="utf-8_sig")
